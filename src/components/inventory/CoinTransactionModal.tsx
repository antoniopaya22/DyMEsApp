...
import { COIN_ABBR, type CoinType } from "@/types/item";
...
export function CoinTransactionModal({
  ...
  const handleSubmit = async () => {
    ...
    setDescription("");
    onClose();
    onShowToast(operation === "add" ? "Monedas añadidas" : "Monedas gastadas");
  };
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <TouchableOpacity
                ...
                style={{
                  backgroundColor:
                    operation === "add"
                      ? withAlpha(colors.accentRed, 0.85)
                      : "transparent",
                }}
              ...
              <TouchableOpacity
                ...
                style={{
                  backgroundColor:
                    operation === "remove"
                      ? withAlpha(colors.accentDanger, 0.85)
                      : "transparent",
                }}
            ...
            {/* Description */}
            <Text
              className="text-xs font-semibold uppercase tracking-wider mb-1.5 mt-3"
              style={{ color: colors.textSecondary }}
            >
            ...
            <TouchableOpacity
              ...
              style={{
                backgroundColor:
                  operation === "add" ? colors.accentRed : colors.accentDanger,
              }}
