...
import { useTheme, useDialog, useCreationNavigation } from "@/hooks";
...
export default function IndexStep() {
  ...
  useEffect(() => {
    ...
    Animated.stagger(90, [
      ...
      // Sex selector
      Animated.parallel([
        Animated.timing(sexAnim, {
          toValue: 1,
          duration: 350,
          easing: Easing.out(Easing.cubic),
          useNativeDriver: true,
        }),
        Animated.timing(sexSlide, {
          toValue: 0,
          duration: 350,
          easing: Easing.out(Easing.cubic),
          useNativeDriver: true,
      ...
      Animated.parallel([
        ...
        Animated.timing(suggestionsSlide, {
          toValue: 0,
          duration: 350,
          easing: Easing.out(Easing.cubic),
          useNativeDriver: true,
    ...
    >
      <View className="flex-1">
        ...
        <View className="flex-1 px-5 justify-center" style={{ marginTop: -60 }}>
          ...
          <Animated.View
            className="mb-6"
            style={{ opacity: sexAnim, transform: [{ translateY: sexSlide }] }}
          >
            <Text
            ...
            <View className="flex-row justify-center">
              {(Object.entries(SEXO_NAMES) as [Sexo, string][]).map(
                ([key, label]) => {
                  ...
                  return (
                    ...
                    >
                      <Ionicons
                        ...
                        size={22}
                        color={
                          selected ? colors.textInverted : colors.textSecondary
                        }
                      />
                      <Text
