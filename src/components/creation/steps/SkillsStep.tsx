        ...
        <View style={[styles.counterBadge, themed.card]}>
          <Text
            style={[
              styles.counterText,
              themed.counterText,
              isValid && [styles.counterTextValid, themed.counterTextValid],
            ]}
          >
        ...
        {availableClassSkills.length === 0 ? (
          <View style={[styles.emptyState, themed.emptyState]}>
            ...
            <Text style={[styles.emptyText, themed.emptyText]}>
              No hay habilidades disponibles para elegir. Esto puede ocurrir si
              todas ya fueron otorgadas por raza y trasfondo.
            </Text>
          </View>
        ) : (
